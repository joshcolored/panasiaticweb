      ...
      <div className="w-full max-w-[1440px] mx-auto">
        <div className="flex flex-col lg:flex-row justify-between items-start gap-8 lg:gap-12">
          ...
          <div className="flex flex-col gap-4 sm:gap-6 justify-start items-start w-full lg:w-[46%]">
            ...
            >
              The most cost-effective call center in the Philippines
            </h1>
            ...
            <p
              ...
              style={{ fontFamily: "Raleway" }}
            >
              We pride ourselves on being a top-performing Customer Experience
              Outsourcing Company, delivering excellent service at
              cost-effective rates - with transparent pricing and no hidden
              fees. 
            </p>
          </div>
